...
function extendTheme(options = {}, ...args) {
  ...
  Object.keys(theme.colorSchemes).forEach((key) => {
    ...
    if (key === "light") {
      ...
      setColor(palette.AppBar, "darkBg", "var(--mui-palette-background-paper)");
      setColor(palette.AppBar, "darkColor", "var(--mui-palette-text-primary)");
...
//# sourceMappingURL=chunk-N7WYT753.js.map
